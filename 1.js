...
function(e, t) {
    ...
    window.copyResult = function() {
        return n.trim(n("#transTarget").html().replace(/<br\s+.*?>/gi, "\n").replace(/<\/p>/gi, "\r\n").replace(/<p.*?>/gi, "").replace(/<span.*?>/gi, "").replace(/<\/span>/gi, "").replace(/&amp;/g, "&").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&copy;/g, "Â©"))
    };
    var o = function() {
        window.clipboardData && (window.clipboardData.clearData(), window.clipboardData.setData("Text", copyResult()) || alert("æ‚¨çš„æµè§ˆå™¨ä¸æ”¯æŒç›´æŽ¥å¤åˆ¶åŠŸèƒ½ï¼Œè¯·æ‰‹åŠ¨å¤åˆ¶ã€‚"))
    };
    t.init = function() {
        function e(e) {
            alert("æ‚¨çš„æµè§ˆå™¨ä¸æ”¯æŒç›´æŽ¥å¤åˆ¶åŠŸèƒ½ï¼Œè¯·æ‰‹åŠ¨å¤åˆ¶ï¼›æˆ–åœ¨æµè§ˆå™¨è®¾ç½®ä¸­å¼€å¯flashæ’ä»¶åŠŸèƒ½ã€‚")
        }
        ...
        !(n("#copyit").length > 0)) {
            if (Clipboard.isSupported()) {
                ...
                return t.on("success",
                function(e) {
                    n("#targetCopy .tips__text--short").text("å·²å¤åˆ¶"),
                    r.clog("COPY_CLICK"),
                    setTimeout(function() {
                        n("#targetCopy .tips__text--short").text("å¤åˆ¶")
                    },
                    1e3)
                }),
                void t.on("error",
                function(e) {
                    r.clog("COPY_CLICK"),
                    alert("æ‚¨çš„æµè§ˆå™¨ä¸æ”¯æŒç›´æŽ¥å¤åˆ¶åŠŸèƒ½ï¼Œè¯·æ‰‹åŠ¨å¤åˆ¶ã€‚")
                })
            }
    ...
    function l(e) {
        ...
        setTimeout(function() {
            if (0 == e.errorcode && e.key) {
                ...
                percent: "0%",
                name: ""
            }), N ? N = !0 : alert("ä¸Šä¼ æˆ–è§£æžå¤±è´¥ï¼ˆé”™è¯¯ä»£ç :" + e.errorcode + "ï¼‰"))
        },
        500)
    }
    function c() {
        ...
        function() {
            ...
            if (h.switchMode(!0), t.isDocMode = !0, t.isDocReady = !1, p("#docLangTip").show(), e && e[0] && e[0].size && (n = e[0].size), "" != (i = e && e[0] && e[0].name ? e[0].name: i.split("\\")[i.split("\\").length - 1])) {
                if (!/(.doc|.docx|.pdf)$/i.test(i)) return o(!0, {
                    msg: "æ ¼å¼é”™è¯¯ï¼Œè¯·ä½¿ç”¨docxï¼docï¼pdfæ ¼å¼",
                    name: i,
                    size: r(n)
                }),
    ...
    t.uploadFile = function() {
        ...
        k = T.ajaxForm({
            ...
            error: function(e, t) {
                ...
                u(),
                N ? N = !0 : (alert("ä¸Šä¼ å¤±è´¥ï¼Œè¯·é‡è¯•ã€‚"), window.location.reload())
            }
        }),
        c(),
        T.submit()
...
function(e, t) {
    ...
    function o(e) {
        if (0 == u('li[data-value="' + e + '"]').length) u("#langSelect").selectValue("AUTO");
            ...
            A.state.isSelectLan || u(".select-text").text("æ£€æµ‹åˆ°ï¼š" + t)
        }
    }
    function a(e) {
    ...
    t.translate = function(e, t) {
        ...
        if (L(), w.text(a), a > 5e3) {
            ...
            u("#inputTargetError").text("æœ‰é“ç¿»è¯‘å­—æ•°é™åˆ¶ä¸º5000å­—ï¼Œâ€œ" + c + "â€åŠå…¶åŽé¢æ²¡æœ‰è¢«ç¿»è¯‘!").show(),
...
function(e) {
    ...
    return {
        ...
        addToFav: function() {
            t.browser.msie ? window.external.addFavorite("http://fanyi.youdao.com/?keyfrom=favorite", "æœ‰é“ç¿»è¯‘ - å…è´¹åœ¨çº¿ç¿»è¯‘") : alert("è¯·ä½¿ç”¨Ctrl + D æ‰‹åŠ¨åŠ å…¥æ”¶è—")
        },
...
function(e, t) {
    ...
    t.showVoice = function(e) {
        d[e] && g() <= 300 ? (s.removeClass("speaker-disable").show(), s.find(".tips__text--short").text("æœ—è¯»")) : d[e] && g() > 300 ? (s.addClass("speaker-disable").show(), s.find(".tips__text--short").text("æ–‡æœ¬è¿‡é•¿ï¼Œæœ—è¯»å…³é—­")) : s.hide()
    },
    t.init = function() {
        window.swfReady = !1,
        window.jsReady = !1,
...
function(e, t) {
    ...
    t.switchMode = function(e) {
        ...
        e ? "zh-CHS2en" != r && "en2zh-CHS" != r && (n("#langSelect .default a").text("è¯·é€‰æ‹©è¯­è¨€"), n("#langSelect").addClass("empty-lang"), n("#langSelect").selectValue("AUTO")) : (n("#langSelect .default a").text("è‡ªåŠ¨æ£€æµ‹è¯­è¨€"), n("#langSelect").removeClass("empty-lang"), n("#langSelect").selectValue("AUTO"))
    },
